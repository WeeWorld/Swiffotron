...
namespace SWFProcessing.SWFModeller.ABC.Debug
{
    ...
    public interface IABCLoadInterceptor
    {
        ...
        /// <param name="ctx">The SWF fiddling context, for debug identification</param>
        ...
        void OnLoadAbc(bool lazyInit, SWFContext ctx, string abcName, int doAbcCount, byte[] bytecode);
    }
}
